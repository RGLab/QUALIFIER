...
#'
#'@docType methods
#'@param db An environment storing all the QA data. By default it is an hidden
#'global environment \code{.db}.
...
#' 
#' @usage getQAStats(obj, ...) getQAStats(obj, gsid, ...)
#' 
#'@return
#'
#'\code{saveToDB} returns an automatically generated gating set id.
#'\code{getQAStats} a data frame when obj is a \code{GatingHierarchy} or
#'\code{GatingSet}, \code{qaPreprocess} returns the list of elements within the
#'data environment.
#'
